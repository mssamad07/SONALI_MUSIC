...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","AS_Jinwoo")
# --------------------------------------------------------
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ABS_Updates")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/49rq1n.mp4"
)
PING_IMG_URL = getenv(
